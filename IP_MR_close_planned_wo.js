 ...
 * Change the Work Order status from Planned to Release, to close those WO that already have Work Order Close.
 *
...
define(["N/search", "N/record", "N/runtime"], function(
  ...
  function getInputData() {
    var stSearch_NAME = objCurrentScript.getParameter(
      "custscript_mr_close_wo_planned_search"
    );
